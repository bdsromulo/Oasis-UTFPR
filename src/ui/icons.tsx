...
export function LogoUTFPR(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      {/* Emblema geométrico estilizado UTFPR - traço forte e minimalista */}
      <rect x="12" y="12" width="76" height="76" rx="18" className="fill-utfpr-500 dark:fill-utfpr-500" />
      <path
        d="M32 36H68M50 36V66M38 66H62"
        stroke="currentColor"
        strokeWidth="8"
        strokeLinecap="round"
